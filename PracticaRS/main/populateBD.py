...
# Asegúrate de que los archivos 'anime.csv' y 'ratings.csv' están ahí dentro.
path = "data"
...
def populate():
    ...
    # 1. Cargar Animes y obtener el diccionario para optimizar
    dict_animes = populateAnimes()
    
    # 2. Cargar Puntuaciones usando el diccionario
    populateRatings(dict_animes)
...
def populateRatings(dict_animes):
